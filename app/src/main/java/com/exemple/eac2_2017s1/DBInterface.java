...
//        initialValues.put(IMAGEN, imagen);
    ...
    public Cursor getAll(){
        return db.query(TABLE_NAME, new String[] {TITULO, DESCRIPCION, ENLACE, AUTOR, FECHA, CATEGORIA}, null, null, null, null, null);
    }
    ...
    public void insert(String titulo, String descripcion, String enlace, String autor, String fecha, String categoria) {
    }
    ...
    private static class DBHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int VersioAntiga, int VersioNova) {
            Log.w(TAG, "Updating Version Database" + VersioAntiga + " a " + VersioNova + ". It will destroy all the data");
            db.execSQL("DROP TABLE IF EXISTS " + TABLE_NAME);
